  ...
  UserInterface = (function() {
    ...
    UserInterface.prototype._initializeUI = function() {
      ...
      $('#newItem').click(function() {
        ...
        if (text != null) {
          firstItem = _this._itemFromElement($('.item:first'));
    ...
    UserInterface.prototype._positionItem = function(element, thisItem) {
      var el, item, upper, _i, _len, _ref;
      upper = void 0;
      _ref = $('.item');
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        el = _ref[_i];
        item = this._itemFromElement($(el));
        if ((item != null) && Item.comparator(thisItem, item) < 0) {
          upper = item;
          break;
        }
      }
      if (upper != null) {
        return element.insertBefore($('#item_' + item.getID()));
      } else {
    ...
    UserInterface.prototype._createElement = function(id) {
      var el,
        _this = this;
      el = $('<table class="item">' + '<tr>' + '<td class="item-buttons-left">' + '<button class="resolved" data-mini="true" ' + 'data-icon="check" data-iconpos="notext" />' + '</td>' + '<td class="item-center">' + '<div class="item-text"></div>' + '</td>' + '<td class="item-buttons-menu">' + '<button class="acceptEdit" data-inline="true" data-mini="true" ' + 'data-icon="check" data-iconpos="notext" />' + '<button class="abortEdit" data-inline="true" data-mini="true" ' + 'data-icon="delete" data-iconpos="notext" />' + '<button class="move" data-inline="true" data-mini="true" ' + 'data-icon="arrow-d" data-iconpos="notext" />' + '<button class="edit" data-inline="true" data-mini="true" ' + 'data-icon="edit" data-iconpos="notext" />' + '</td>' + '<td class="item-buttons-right">' + '<button class="menu" data-inline="true" data-mini="true" ' + 'data-icon="grid" data-iconpos="notext" />' + '</td>' + '</tr>' + '</table>').attr('id', 'item_' + id);
      $('button', el).button();
    ...
    UserInterface.prototype._showEditingButtonState = function(id) {
      ...
      return $('.edit, .move', '#item_' + id).closest('.ui-btn').hide();
    };
    ...
    UserInterface.prototype._showNonEditingState = function(id) {
      ...
      return $('.edit, .move', '#item_' + id).closest('.ui-btn').show();
    };
