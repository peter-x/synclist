  ...
  RemoteStorageBackend = (function() {
    ...
    RemoteStorageBackend.prototype.list = function() {
      ...
      if (!this._rs.connected) {
        ...
        this._rs.get('/synclist/').then((function(code, result, mimetype) {
          return d.resolve(Utilities.setToArray(result));
        }), function() {
          return d.reject();
        });
      }
    ...
    RemoteStorageBackend.prototype.get = function(key) {
      ...
      if (!this._rs.connected) {
        ...
        this._rs.get('/synclist/' + key).then((function(code, data, mimetype, revision) {
    ...
    RemoteStorageBackend.prototype.put = function(key, data) {
      ...
      if (!this._rs.connected) {
        ...
        this._rs.put('/synclist/' + key, data, 'text/plain').then((function() {
          return d.resolve();
        }), function() {
          return d.reject();
        });
